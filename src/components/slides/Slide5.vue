  ...
  <ScrollView class="p-5">
    <StackLayout verticalAlignment="center">
      ...
      <GridLayout ref="stats" class="mt-8" columns="*, *, *" rows="*">
        <SquircleContentView cornerSmoothing="10" squircleBorderWidth="1" squircleBorderColor="#ffffff33" class="info-card m-1" row="0" col="0">
        ...
        <SquircleContentView cornerSmoothing="10" squircleBorderWidth="1" squircleBorderColor="#ffffff33" class="info-card m-1" row="0" col="1">
          <StackLayout class="text-center p-4">
        ...
        <SquircleContentView cornerSmoothing="10" squircleBorderWidth="1" squircleBorderColor="#ffffff33" class="info-card m-1" row="0" col="2">
          <StackLayout class="text-center p-4">
