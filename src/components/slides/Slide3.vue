  ...
  <ScrollView class="p-5">
    <StackLayout verticalAlignment="center">
      ...
      <GridLayout class="mt-5" columns="*, *" rows="*, *">
        <SquircleContentView ref="featureCard1" class="info-card m-2.5 text-center" row="0" col="0" squircleBorderWidth="2" squircleBorderColor="#ffffff33">
        ...
        <SquircleContentView ref="featureCard2" class="info-card m-2.5 text-center" row="0" col="1" squircleBorderWidth="2" squircleBorderColor="#ffffff33">
          <StackLayout class="text-center m-8">
            <Label class="text-3xl text-center mb-2.5">📱</Label>
        ...
        <SquircleContentView ref="featureCard3" class="info-card m-2.5 text-center" row="1" col="0" squircleBorderWidth="2" squircleBorderColor="#ffffff33">
          <StackLayout class="text-center m-8">
            <Label class="text-3xl text-center mb-2.5">🚀</Label>
        ...
        <SquircleContentView ref="featureCard4" class="info-card m-2.5 text-center" row="1" col="1" squircleBorderWidth="2" squircleBorderColor="#ffffff33">
          <StackLayout class="text-center m-8">
            <Label class="text-3xl text-center mb-2.5">⚡</Label>
